    ...
    private function checkShips(Lands $land): bool
    {
        ...
        if (count($ships) > 0) {
            if ($this->user->getPa() > 0) {
                ...
                $copper = random_int(25, 100) * $nb_explorers;

                $this->setSuccess('Votre équipage part braconner et récolte <span class="brown-text">' . $copper . ' morceaux de Cuir</span>, <span class="green-text">' . $food . ' portions de Nourriture</span>, <span class="green-text">' . $alcohol . ' portions d\'Alcool</span> ainsi que <span class="gold-dark">' . $gold . ' Pièces d\'Or</span>.');
